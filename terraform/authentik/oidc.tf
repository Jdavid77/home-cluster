  ...
  oidcs = [
    {
      ...
      authentik_oidc_client_type             = "confidential"
      authentik_oidc_sub_mode                = "hashed_user_id"
...
module "oidc" {
  ...
  authentik_oidc_client_type             = each.value.authentik_oidc_client_type
  authentik_oidc_sub_mode                = each.value.authentik_oidc_sub_mode
}
